...
```bash
nicegui-builder form run nicegui_builder.plugins.pydantic.examples.models:Participant
nicegui-builder form run nicegui_builder.plugins.pydantic.examples.models:Contest --flavor actionable
```
